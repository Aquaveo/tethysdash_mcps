...
Complements :mod:`tethysdash_mcp.editable_schemas` (which owns the
...
from tethysdash_mcp.plugin_helpers import get_plugin_prop
...
def resolve_editable_paths(source: str) -> List[str]:
    ...
    routing static-built-in sources to :mod:`tethysdash_mcp.editable_schemas`
...
def is_path_allowed_plugin(source: str, json_pointer: str) -> bool:
    ...
    :func:`tethysdash_mcp.editable_schemas.is_path_allowed` -- so
