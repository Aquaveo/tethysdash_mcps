...
from tethysdash_mcp.mcp_server import patch_visualization
...
def _spy_rejection_telemetry(mocker):
    ...
    """
    return mocker.patch(
        "tethysdash_mcp.mcp_server._emit_rejection_telemetry"
    )
...
class TestPluginSourceDispatch:
    ...
    def test_intake_plugin_happy_path(self, mocker):
        ...
        mocker.patch(
            "tethysdash_mcp.editable_schemas_plugin.intake.source.registry",
